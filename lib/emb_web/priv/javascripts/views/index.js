    ...
    render: function() {
        if(this.images.length > 0) {
            ...
            _(this.images).each(function(item) {
                out += "<li><a href='" + item.get('fullsize') + "' id='"+ item.get('id') +"' title='"+item.get('tags')+"'><img src='" + item.get('thumbnail') + "' /></a></li>";
            });
            out += "</ul>";
            out += "<div id='main_view'>";
	        out += "<a href='"+this.images[0].get('fullsize')+"' id='"+ this.images[0].get('id') +"' title='"+this.images[0].get('tags')+"' target='_blank'><img src='"+this.images[0].get('fullsize')+"' alt=\"\" /></a><br />";
            out += "<div>";
