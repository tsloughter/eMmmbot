...
(function( $ ){
  $.fn.jQCloud = function(word_array, callback_function) {
    ...
    var drawWordCloud = function() {
      ...
      word_array.sort(function(a, b) { if (a.value < b.value) {return 1;} else if (a.value > b.value) {return -1;} else {return 0;} });
      ...
      $.each(word_array, function(index, word) {
        ...
        var weight = Math.round((word.value - word_array[word_array.length - 1].value)/(word_array[0].value - word_array[word_array.length - 1].value) * 9.0) + 1;

        var inner_html = word.url !== undefined ? "<a href='" + word.url + "'>" + word.key + "</a></span>" : word.key;
